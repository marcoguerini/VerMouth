...
If you use the VerMouth datasets or any partial sections of it in your work, we kindly request to [cite](https://github.com/marcoguerini/VerMouth/new/main?readme=1#bibtex-citation) our original paper.
